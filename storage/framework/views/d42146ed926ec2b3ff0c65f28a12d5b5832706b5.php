                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($result->test_subject); ?></td>
                                <td><?php echo e($result->test_topic_name); ?></td>
                                ...
                                <td><a class="badge bg-danger" href="<?php echo e(route("model_test.delete",[$result->id])); ?>">Delete</a></td>
                            </tr>
...
<?php echo $__env->make("template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Salauddin\Desktop\Files\Nahid24\resources\views/ModelTest/index.blade.php ENDPATH**/ ?>