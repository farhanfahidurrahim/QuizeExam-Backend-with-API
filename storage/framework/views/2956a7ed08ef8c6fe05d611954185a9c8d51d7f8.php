            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Intgernational Affair - Australia PDF</h4>
                    </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="<?php echo e(route('learn.interaff.store')); ?>" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="topic_name" value="Australia">
                                <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\office\quizeApp\resources\views/Learn/InternationalAffair/australia.blade.php ENDPATH**/ ?>