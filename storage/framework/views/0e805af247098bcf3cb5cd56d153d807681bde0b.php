            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add English - Category PDF</h3>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="<?php echo e(route("bank.english.storecat")); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <form class="px-3"
                                        ...
                                        method="POST" action="<?php echo e(route('bank.engcat.destroy', $result->id)); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make("template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\office\quizeApp\resources\views/Bank/English/add_category.blade.php ENDPATH**/ ?>