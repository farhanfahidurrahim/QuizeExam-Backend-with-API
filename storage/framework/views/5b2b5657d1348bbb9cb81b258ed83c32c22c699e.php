            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li
                        ...
                        <ul class="submenu ">
                            <li class="submenu-item ">
                                <a href="<?php echo e(route("courses.index")); ?>">All Course</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="<?php echo e(route("courses.store")); ?>">Add Course</a>
                            </li>
                    ...
                    <li
                        ...
                        <ul class="submenu ">
                            <li class="submenu-item ">
                                <a href="<?php echo e(route("product.index")); ?>">All Products</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="<?php echo e(route("product.store")); ?>">Add product</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="<?php echo e(route("product.orders")); ?>">Orders</a>
                            </li>
                        </ul>
                    </li>
...
<?php /**PATH C:\Users\Salauddin\Desktop\Files\Nahid24\resources\views/template.blade.php ENDPATH**/ ?>