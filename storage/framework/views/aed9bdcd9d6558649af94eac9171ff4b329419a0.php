            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Current Affairs - International PDF</h4>
                    </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="<?php echo e(route('currentaffairs.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="subject_name" value="International">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                        	...
                                        	<input type="text" id="city-column" class="form-control"  placeholder="Enter Month & Date! Ex: April 2023" name="month_year" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($result->month_year); ?></td>
                                ...
                                <td class="d-flex">
                                    ...
                                    <form class="px-3"
                                        ...
                                        method="POST" action="<?php echo e(route('currentaffairs.destroy', $result->id)); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\office\quizeApp\resources\views/CurrentAffairs/international.blade.php ENDPATH**/ ?>