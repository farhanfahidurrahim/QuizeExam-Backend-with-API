            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Vacabulary - Barrons 333 PDF</h4>
                    </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="<?php echo e(route('vocabulary.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                
                                <input type="hidden" name="topic_name" value="Barrons 333">
                                <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <form class="px-3"
                                        ...
                                        method="POST" action="<?php echo e(route('vocabulary.destroy', $result->id)); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\office\quizeApp\resources\views/Vocabulary/barrons333.blade.php ENDPATH**/ ?>