<?php $__env->startSection("body"); ?>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route("quiz.topics.store")); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">

                                    <select class="form-control" name="quiz_subject">
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$subjects): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="badge bg-danger" href="<?php echo e(route("quiz.topics.delete",[$subjects->id])); ?>">Delete</a>
                                ...
                                <div class="modal fade text-left" id="backdrop<?php echo e($subjects->id); ?>" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="<?php echo e(route("quiz.topics.edit",[$subjects->id])); ?>">

                                                <?php echo csrf_field(); ?>
                                                <div class="modal-body">
                                                    <select class="form-control" name="quiz_subject">
                                                        <?php $__currentLoopData = $subject; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($sub->id); ?>" <?php if($sub->id==$subjects->quiz_subject_id): ?> <?php echo e($value="selected"); ?> <?php endif; ?>><?php echo e($sub->quiz_subject); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </br>
...
<?php echo $__env->make("template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Salauddin\Desktop\Files\Nahid24\resources\views/Quiz/topic.blade.php ENDPATH**/ ?>