            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Computer Ict - Category PDF</h3>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="<?php echo e(route("compict.cat.store")); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="row">
...
<?php echo $__env->make("template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\office\quizeApp\resources\views/Learn/ComputerIct/add_category.blade.php ENDPATH**/ ?>