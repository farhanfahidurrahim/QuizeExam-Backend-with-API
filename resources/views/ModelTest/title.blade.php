...
@section("body")
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{route("model_test.title.store")}}">
                        @csrf
                        <div class="row">
                    ...
                    @foreach($data as $key=>$subjects)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="badge bg-danger" href="{{route("model_test.title.delete",[$subjects->id])}}">Delete</a>
                                ...
                                <div class="modal fade text-left" id="backdrop{{$subjects->id}}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{route("model_test.title.edit",[$subjects->id])}}">

                                                @csrf
                                                <div class="modal-body">

                                                    <input type="text" class="form-control" name="test_title" placeholder="Enter Title Name" value="{{$subjects->test_title}}">
