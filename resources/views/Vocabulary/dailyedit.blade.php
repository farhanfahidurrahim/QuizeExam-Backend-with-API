            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Vocabulary - Daily Editorial PDF</h4>
                    </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{ route('vocabulary.store') }}" enctype="multipart/form-data">
                                @csrf
                                {{-- <input type="hidden" name="subject_name" value="Computer Ict"> --}}
                                <input type="hidden" name="topic_name" value="Daily Editorial">
                                <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <form class="px-3"
                                        ...
                                        method="POST" action="{{ route('vocabulary.destroy', $result->id) }}">
                                        @csrf
                                        @method('DELETE')
