            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Geography Environment - International Geography PDF</h4>
                    </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{ route('learn.geographyEnv.store') }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="subject_name" value="Geography Environment">
                                <input type="hidden" name="topic_name" value="International Geography">
                                <div class="row">
