            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">All Bangla Literature - PDF</h4>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{route("bangla.literature.store")}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="subject_name" value="Bangla Literature">
                                <div class="row">
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        @foreach($data as $result)
                            <tr>
                                ...
                                <td>{{$result->catbnlit->category_name}}</td>
                                <td>{{$result->title}}</td>
                                ...
                                <td class="d-flex">
                                    <form class="px-3"
                                        ...
                                        method="POST" action="{{ route('bangla.literature.destroy', $result->id) }}">
                                        @csrf
                                        @method('DELETE')
