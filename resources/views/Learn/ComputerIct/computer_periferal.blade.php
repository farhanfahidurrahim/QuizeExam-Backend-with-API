            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Computer Ict - Computer Periferal PDF</h4>
                    </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{ route('learn.computerIct.store') }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="subject_name" value="Computer Ict">
                                <input type="hidden" name="topic_name" value="Computer Periferal">
                                <div class="row">
