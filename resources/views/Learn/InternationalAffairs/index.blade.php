            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{ route('intaff.store') }}" enctype="multipart/form-data">
                                @csrf
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        @foreach($data as $result)
                            <tr>
                                ...
                                <td>{{$result->intaff->category_name}}</td>
                                <td>{{$result->title}}</td>
                                ...
                                <td class="d-flex">
                                    <form class="px-3"
                                        ...
                                        method="POST" action="{{ route('intaff.destroy', $result->id) }}">
                                        @csrf
                                        @method('DELETE')
