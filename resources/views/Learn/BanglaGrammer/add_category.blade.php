            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Bangla Grammer - Category PDF</h3>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{route("bangla.gram.category.store")}}">
                                @csrf
                                <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <form class="px-3"
                                        ...
                                        method="POST" action="{{ route('banglagram.cat.destroy', $result->id) }}">
                                        @csrf
                                        @method('DELETE')
