            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{ route('currentaffairs.store') }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="subject_name" value="International">
                                {{-- <input type="hidden" name="topic_name" value="Bangladesh"> --}}
                                <div class="row">
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    {{-- <h4>All English Literature - Old Period PDF</h4> --}}
                </div>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <form class="px-3"
                                        ...
                                        method="POST" action="{{ route('currentaffairs.destroy', $result->id) }}">
                                        @csrf
                                        @method('DELETE')
